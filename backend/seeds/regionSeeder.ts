...
import { BigRegion } from "../src/entities/BigRegion";
import { SmallRegion } from "../src/entities/SmallRegion";

const bigRegionsData = [
  "서울",
  "부산",
  "대구",
  "인천",
...
const smallRegionsMap: { [key: string]: string[] } = {
  ...
  "울산": ["남구", "동구", "북구", "울주군", "중구"],
  "세종": [
    "가람동", "고운동", "금남면", "나성동", "누리동", "다솜동", "다정동", "대평동",
    "도담동", "반곡동", "보람동", "부강면", "산울동", "새롬동", "세종동", "소담동",
    "소정면", "아름동", "어진동", "연기면", "연동면", "연서면", "용호동", "장군면",
    "전동면", "전의면", "조치원읍", "종촌동", "집현동", "한별동", "한솔동", "합강동", "해밀동"
  ],
  "경기": [
